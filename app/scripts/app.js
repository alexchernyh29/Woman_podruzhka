...
$(() => {
  const wow = new WOW.WOW({
    ...
    $(".slider__wrap__button-prev").on("click", function () {
        ...
        setTimeout(() => {
            $(".slider__wrap__expert").removeClass("visible");
            $(".slider__wrap__user").removeClass("hidden");
        }, 100)
    });
    ...
    $( ".slider__link__mobile" ).on( "click", function() {
        $(".slider__wrap__expert").addClass("visible");
        $(".slider__wrap__user").addClass("hidden");
    });
